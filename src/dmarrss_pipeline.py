...
class DMARRSSPipeline:
    ...
    def process_log_line(self, log_line: str, format_hint: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    def process_log_batch(self, log_lines: List[str], format_hint: Optional[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    def process_log_file(self, file_path: str, format_hint: Optional[str] = None) -> List[Dict[str, Any]]:
        """
